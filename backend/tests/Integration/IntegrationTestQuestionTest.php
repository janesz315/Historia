...
class IntegrationTestQuestionTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
 {
    ...
    public function test_testquestions_http(): void
    {
        ...
        $response = $this->getJson('/api/testQuestions');
       ...
       //  dd($response);
        ...
        // $response = $httpClient->get('http://localhost:8000/api/testQuestions');
