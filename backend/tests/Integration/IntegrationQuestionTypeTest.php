...
class IntegrationQuestionTypeTest extends TestCase
{
    /**
    ...
    public function test_questiontypes_http(): void
    {
       ...
       //  dd($response);
        ...
        // $response = $httpClient->get('http://localhost:8000/api/questionTypes');
